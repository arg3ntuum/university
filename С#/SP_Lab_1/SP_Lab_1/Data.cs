...
namespace SP_Lab_1
{
    public class Data {
        ...
        public static void DownloadMagazines(ComboBox ListMagazines)
        {
        ...
        public static string GetInfo(LotOfToys lotOfToys) =>
            $"Info" +
            $"\n{Line}" +
            $"\nName(партии): {lotOfToys.Name};" +
            $"\n{Line}" +
            $"\nCount: {lotOfToys.Count};" +
            $"\n{Line}" +
            $"\nDate: {lotOfToys.Date.Day}.{lotOfToys.Date.Month}.{lotOfToys.Date.Month};" +
            $"\n{Line}" +
            $"\nToy NameProduct: {lotOfToys.ToyType.NameProduct}" +
            $"\n{Line}" +
            $"\nToy NameOfCompany: {lotOfToys.ToyType.NameOfCompany}" +
            $"\n{Line}" +
            $"\nToy Classification: {lotOfToys.ToyType.Classification}";
